...
async function consultarBalance() {
  try {
    ...
    const url = `https://micuenta2-tigo-com-co-prod.tigocloud.net/api/v2.0/convergent/billing/cc/${numocc}/express/balance?_format=json`;
